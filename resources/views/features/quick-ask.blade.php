    ...
    <div class="bg-gray-50 min-h-screen py-12" x-data="quickAsk({ sessionId: '{{ $sessionId }}' })">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                ...
                <p class="mt-4 text-lg text-gray-500">Tanyakan apapun seputar desain bangunan, dekorasi, atau konstruksi.
                </p>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6 min-h-[400px] flex flex-col justify-between" id="chat-container">
                ...
                <div class="flex-1 overflow-y-auto space-y-4 mb-4" id="chat-messages">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 bg-gray-100 rounded-lg p-3 max-w-lg">
                            <p class="text-sm text-gray-800">Halo! Saya asisten virtual Ruang Temu. Arsitek profesional kami
                                siap menjawab pertanyaan Anda secara live. Apa yang ingin Anda tanyakan hari ini?</p>
                        </div>
                    </div>
                    ...
                    <div x-show="answer" x-cloak class="flex items-start mt-4">
                        ...
                        <div class="ml-3 bg-gray-100 rounded-lg p-3 max-w-lg border border-gray-200 shadow-sm">
                            <p class="text-xs text-blue-600 font-bold mb-1 border-b pb-1"
                                x-text="'Dijawab oleh Arsitek ' + (answer?.architect?.name || '')"></p>
                ...
                <div x-show="!question" x-cloak class="mt-auto border-t pt-4">
                    <form @submit.prevent="submitQuestion" class="flex items-center gap-2">
                        <input type="text" x-model="inputContent"
                            class="flex-1 w-full rounded-full border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-3"
                            placeholder="Ketik pertanyaan Anda di sini... (Cth: Atap spandek panas gak ya?)">
                        <button type="submit" :disabled="loading || inputContent.trim() === ''"
                            class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-bold rounded-full shadow-md text-white bg-gray-600 hover:bg-gray-700 disabled:opacity-50 transition w-24">
                ...
                <div x-show="answer" x-cloak class="mt-auto border-t pt-4 text-center">
                    ...
                    <a :href="'/arsitek/' + (answer?.architect_id || '')"
                        class="text-blue-600 hover:text-blue-800 font-bold underline transition">Booking Konsultasi Lanjutan
                        dengan Arsitek Ini ✨</a>
                </div>
