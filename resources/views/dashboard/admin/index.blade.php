        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow border-l-4 border-gray-500">
                    ...
                    <p class="text-gray-600 mb-4">Ubah profil (username/foto) atau kata sandi Anda di sini.</p>
                    <a href="{{ route('profile.edit') }}" class="bg-gray-500 text-white px-4 py-2 rounded inline-block">Buka Profil</a>
                </div>
            </div>
        </div>
    </div>
